class AddVideos < ActiveRecord::Migration
  ...
  VIDEOS = [
            {:name => 'Lance Toma', :why => lance_toma, :hope => lance_toma, :how => lance_toma, :qa => lance_toma, :youtube_id => 'JZ5PEEeKGOo', :email => 'lance_toma@api.com', :submission_date => '1-Apr-2012', :status => :pending},
            {:name => 'James Kyson-Lee', :why => james_kyson_lee, :hope => james_kyson_lee, :how => james_kyson_lee, :qa => james_kyson_lee, :youtube_id => 'zN7u2VvehyQ', :email => 'james_kyson-lee@api.com', :submission_date => '4-Apr-2012', :status => :accepted},
            {:name => 'Kiran Ahuja', :why => kiran_ahuja, :hope => kiran_ahuja, :how => kiran_ahuja, :qa => kiran_ahuja, :youtube_id => '0NwxHphsCxI', :email => 'kiran_ahuja@api.com', :submission_date => '1-Apr-2012', :status => :accepted}
            ]
  def up
